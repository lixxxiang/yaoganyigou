...
public class SpecialVerticalAdapter extends RecyclerView.Adapter<SpecialVerticalAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SpecialVerticalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_home_horizontal_item, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull SpecialVerticalAdapter.ViewHolder viewHolder, int i) {
    ...
    public SpecialVerticalAdapter(List<HomePageUnitsBean.DataBean.PiecesBean> data, Context context, HomeFragment fragment) {
