...
public class HomeHorizontalAdapter extends RecyclerView.Adapter<HomeHorizontalAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public HomeHorizontalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_home_horizontal_item, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull HomeHorizontalAdapter.ViewHolder viewHolder, int i) {
    ...
    public HomeHorizontalAdapter(List<HomePageUnitsBean.DataBean.PiecesBean> data, Context context, HomeFragment fragment) {
